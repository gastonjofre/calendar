  ...
  days.map((day) => (
    <Card key={`header-${day.short}`} className={classes.root} variant="outlined">
      <Grid container direction="column" justify="center" alignItems="stretch">
        <Typography variant="subtitle1" className={classes.longTitle} color="textSecondary" gutterBottom align="center">
          {day.long}
        </Typography>
        <Typography variant="body2" className={classes.shortTitle} color="textSecondary" gutterBottom align="center">
          {day.short}
        </Typography>
      </Grid>
    </Card>
